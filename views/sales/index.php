                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($sale['coil_code']); ?></td>
                            <td><span class="badge bg-info"><?php echo SALE_TYPES[$sale['sale_type']] ?? $sale['sale_type']; ?></span></td>
                            <td><?php echo number_format($sale['meters'], 2); ?>m</td>
                            <td><?php echo formatCurrency($sale['total_amount']); ?></td>
                            <td><span class="badge <?php echo getStatusBadgeClass($sale['status']); ?>">
                            ...
                            <td>
                                ...
                                $id = $sale['id'];
                                $module = 'sales';
                                $canView = hasPermission(MODULE_SALES_MANAGEMENT, ACTION_VIEW);
                                $canEdit = hasPermission(MODULE_SALES_MANAGEMENT, ACTION_EDIT);
                                $canDelete = hasPermission(MODULE_SALES_MANAGEMENT, ACTION_DELETE);
