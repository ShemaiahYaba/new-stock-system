...
const DEFAULT_PERMISSIONS = [
    ROLE_SUPER_ADMIN => [
        ...
        MODULE_INVOICE_MANAGEMENT => [ACTION_VIEW, ACTION_CREATE, ACTION_EDIT, ACTION_DELETE],
        MODULE_SUPPLY_MANAGEMENT => [ACTION_VIEW, ACTION_CREATE, ACTION_EDIT, ACTION_DELETE],
        MODULE_REPORTS => [ACTION_VIEW],
        MODULE_DASHBOARD => [ACTION_VIEW],
        MODULE_COLOR_MANAGEMENT => [ACTION_VIEW, ACTION_CREATE, ACTION_EDIT, ACTION_DELETE],
        ...
        MODULE_KZINC_MANAGEMENT => [ACTION_VIEW, ACTION_CREATE, ACTION_EDIT, ACTION_DELETE],
    ],
    ROLE_STOCK_MANAGER => [
        MODULE_STOCK_MANAGEMENT => [ACTION_VIEW, ACTION_CREATE, ACTION_EDIT, ACTION_DELETE],
        MODULE_WAREHOUSE_MANAGEMENT => [ACTION_VIEW, ACTION_CREATE, ACTION_EDIT, ACTION_DELETE],
        ...
        MODULE_REPORTS => [ACTION_VIEW],
        MODULE_DASHBOARD => [ACTION_VIEW],
        MODULE_COLOR_MANAGEMENT => [ACTION_VIEW, ACTION_CREATE, ACTION_EDIT],
    ...
    ROLE_ACCOUNTANT => [
        ...
        MODULE_KZINC_MANAGEMENT => [ACTION_VIEW],
        MODULE_REPORTS => [ACTION_VIEW],
        MODULE_DASHBOARD => [ACTION_VIEW],
    ],
    ROLE_SALES_MANAGER => [
        ...
        MODULE_STOCK_MANAGEMENT => [ACTION_VIEW],
        MODULE_KZINC_MANAGEMENT => [ACTION_VIEW, ACTION_CREATE],
        MODULE_DASHBOARD => [ACTION_VIEW],
    ],
    ROLE_VIEWER => [
        MODULE_DASHBOARD => [ACTION_VIEW],
